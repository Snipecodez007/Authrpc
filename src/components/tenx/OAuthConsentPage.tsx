// boozoRpc — OAuth consent preview page (mirrors Discord's consent screen)
'use client'
      ...
      <div className="relative z-10 px-4 sm:px-6 py-6 max-w-md mx-auto w-full">
        ...
        <Card className="space-y-5">
          ...
          <div className="text-center space-y-1">
            ...
            <h1 className="text-2xl font-bold text-white">boozoRpc PRO</h1>
          </div>
          ...
          <div className="space-y-2">
            <p className="text-xs text-white/70 font-medium">
              This will allow the developer of <strong className="text-white">boozoRpc PRO</strong> to:
            </p>
        ...
        <p className="text-center text-xs text-white/40 mt-6">
          By authorizing, you agree to boozoRpc&apos;s Terms of Service and Privacy Policy.
        </p>
      </div>
    </div>
  )
