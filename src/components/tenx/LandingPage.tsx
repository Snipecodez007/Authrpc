// boozoRpc — Landing page (matches Roxy reference: hero + seamless experience + pricing)
'use client'
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <nav className="flex items-center justify-between px-4 sm:px-8 py-4 sm:py-6">
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg sm:text-xl font-bold text-white">boozoRpc</span>
        </div>
        <div className="flex items-center gap-2">
      ...
      <footer className="px-4 sm:px-8 py-10 border-t border-white/5">
        <div className="max-w-2xl mx-auto text-center space-y-4">
          ...
          <p className="text-xs text-white/40">Copyright © 2026 boozoRpc. All rights reserved.</p>
          <p className="text-xs text-white/30 max-w-md mx-auto">
            boozoRpc is not affiliated with, endorsed, or sponsored by Discord Inc.
          </p>
        </div>
      </footer>
    </div>
