// boozoRpc — Main dashboard page (#/dashboard)
'use client'
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="glass-card p-8 max-w-md text-center">
          ...
          <h1 className="text-2xl font-bold text-white mb-2">Welcome to boozoRpc</h1>
    ...
    <div className="min-h-screen px-4 sm:px-6 py-6 max-w-2xl mx-auto pb-12">
      ...
      <header className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg font-bold text-white">boozoRpc</span>
        </div>
        <div className="flex items-center gap-2">
          <a
