// boozoRpc — Status Rotator page (#/rotator) with Add Preset modal + reordering
'use client'
    ...
    <div className="min-h-screen px-4 sm:px-6 py-6 max-w-2xl mx-auto">
      ...
      <Card>
        ...
        {loading ? (
          ...
          <div className="glass-card-inner p-8 text-center space-y-3">
            ...
            <p className="text-xs text-white/40 max-w-xs mx-auto">
              Create up to 20 presets and boozoRpc will cycle through them automatically at the duration you set.
            </p>
        ...
        <p className="text-xs text-white/40 italic mt-6 text-center">
          ⚠ boozoRpc is not responsible if your account gets banned or blocked. Use at your own risk.
        </p>
      </Card>
