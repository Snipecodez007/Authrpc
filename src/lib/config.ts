// boozoRpc — Central configuration
...
export const CONFIG = {
  ...
  session: {
    cookieName: 'boozorpc_session',
    ttlDays: 7,
    secret: process.env.SESSION_SECRET || 'boozorpc-dev-secret-change-me-in-production-32bytes-min',
  },
  admin: {
    // Discord user IDs that have admin access
    discordIds: ['1087346593235210311'],
  },
}
